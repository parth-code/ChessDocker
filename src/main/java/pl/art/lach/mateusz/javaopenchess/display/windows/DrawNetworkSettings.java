...
//
//    private static final String REGEXP_IP = "[0-9]{1,3}\\.[0-9]{1,3}\\.[0-9]{1,3}\\.[0-9]{1,3}";
//
...
//    private ServerOptionsPanel servOptions;
...
//        this.servOptions = new ServerOptionsPanel();
//
...
//            {
//                Pattern ipPattern = Pattern.compile(REGEXP_IP);
//                String ip = this.clientOptions.textServIP.getText();
...
//                server.newTable(Integer.parseInt(textGameID.getText()), pass,
//                    !servOptions.checkWitchoutObserver.isSelected(),
//                    !servOptions.checkDisableChat.isSelected()
//                );
//                clientOptions.textServIP.setText(LOCALHOST_IP);
//                try
//                {
//                    Thread.sleep(100);
//                }
...
//            try
//            {
//                client = new Client(clientOptions.textServIP.getText(), Server.PORT);
//                boolean isJoining = client.join(
//                    Integer.parseInt(textGameID.getText()),
//                    !clientOptions.checkOnlyWatch.isSelected(),
//                    textNick.getText(),
//                    MD5.encrypt(textPassword.getText())
//                );
//
//                if (isJoining)
//                {
//                    LOG.debug("Client connection: succesful");
//                    Game newGUI = null//JChessApp.getJavaChessView()
//                        .createNewGameTab("Network game, table: " + textGameID.getText());
...
//    }
//
//    private class ServerOptionsPanel extends JPanel
//    {
//        private static final long serialVersionUID = 1L;
//        private GridBagLayout gbl;
//        private GridBagConstraints gbc;
