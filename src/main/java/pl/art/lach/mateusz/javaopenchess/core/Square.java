...
public class Square
{
    protected static final int ASCII_OFFSET = 97;
	...
	public <T extends Piece> T getPiece() {
        return (T) piece;
    }
    ...
    public int hashCode()
    {
        return Objects.hash(pozX, pozY, piece);
    }
    ...
    public boolean equals(Object obj)
    {
        ...
        return sq.getPozX() == this.getPozX()
            && sq.getPozY() == this.getPozY()
            && Objects.equals(sq.getPiece(), this.getPiece());
    }
}
