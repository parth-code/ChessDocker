...
//            isUpsideDown.setSelected(settings.isUpsideDown());
//            isDisplayLegalMovesEnabled.setSelected(settings.isDisplayLegalMovesEnabled());
//            isRenderLabelsEnabled.setSelected(settings.isRenderLabels());
//        }
//    }
//
//    @Override
...
//        {
//            settings.setUpsideDown(isUpsideDown.isSelected());
//        }
//        else if (clickedComponent == isDisplayLegalMovesEnabled)
//        {
//            boolean isSelected = isDisplayLegalMovesEnabled.isSelected();
//            settings.setDisplayLegalMovesEnabled(isSelected);
//        }
//        else if (clickedComponent == isRenderLabelsEnabled)
//        {
//            boolean isSelected = isRenderLabelsEnabled.isSelected();
//            settings.setRenderLabels(isSelected);
//            game.resizeGame();
//        }
//        game.repaint();
//    }
